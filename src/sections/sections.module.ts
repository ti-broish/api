...
import { Section, Country, ElectionRegion, Town, Municipality, CityRegion } from './entities';
...
@Module({
  imports: [TypeOrmModule.forFeature([Section, Town, Municipality, ElectionRegion, Country, CityRegion]), CaslModule],
  providers: [SectionsRepository, CountriesRepository, ElectionRegionsRepository, MunicipalitiesRepository, TownsRepository, IsSectionExistsConstraint, IsTownExistsConstraint, CityRegionsRepository],
  exports: [SectionsRepository, ElectionRegionsRepository, MunicipalitiesRepository, CountriesRepository, CityRegionsRepository],
