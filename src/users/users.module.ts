...
@Module({
  imports: [TypeOrmModule.forFeature([User, Organization]), CaslModule],
  providers: [UsersRepository, OrganizationsRepository, RegistrationService, IsOrganizationExistsConstraint, IsUserExistsConstraint],
